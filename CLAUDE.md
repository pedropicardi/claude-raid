...
4. Adds Raid-specific env vars (`CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS: '1'`) and auto-approve permissions (Read, Glob, Grep, Bash(*), Write(*), Edit(*), Agent, SendMessage, TaskCreate, TaskUpdate, TeamCreate)
